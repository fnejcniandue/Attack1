...
TOKEN = "7947479058:AAGdfpOcUXwTusFt7ULgAgLbbslrc3E6v5M"
FORWARD_CHANNEL_ID = -1002447886308
...
ANY INQUIRYS AND BUY_ @RitikXyz099।
...
def process_attack_command(message):
    try:
        ...
        bot.send_message(message.chat.id, "⚠️ If you do not provide feedback, you may be banned from the group. plz provide feedback. @RitikXyz099")
